      ...
      <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
        ...
        {validationResult ? (
          <div className="space-y-6 py-4">
            {/* Error State */}
            {'type' in validationResult &&
            (validationResult as Record<string, unknown>).type === 'error' ? (
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-lg font-semibold text-red-500">Validation Failed</p>
                    <p className="text-sm text-muted-foreground">
                      The AI validation encountered an error
                    </p>
                  </div>
                </div>
                <div className="bg-muted/30 p-3 rounded-lg border border-border">
                  <p className="text-sm text-muted-foreground font-mono">
                    {((validationResult as Record<string, unknown>).error as Record<string, string>)
                  ...
                  <div className="flex items-center gap-3">
                    {(() => {
                      const config = verdictConfig[validationResult.verdict] ?? {
                        label: validationResult.verdict ?? 'Unknown',
                      ...
                      <div className="flex-1">
                        ...
                        {validationResult.prAnalysis.prNumber && (
                          <p className="text-xs text-muted-foreground mt-0.5">
                            ...
                            {validationResult.prAnalysis.prFixesIssue &&
